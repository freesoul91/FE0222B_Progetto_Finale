...
import { StatoFattura } from 'src/app/models/S-fattura';
import { StatoFatturaService } from 'src/app/services/s-fattura.service';
...
export class DettaglioFattureComponent implements OnInit {
  ...
  CaricaStatoFatture() {
    this.statoFatturaService.GetAll(0).subscribe((data) => {
